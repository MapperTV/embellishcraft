...
public class WorldgenConfig
{
    ...
    public static void init(ForgeConfigSpec.Builder SERVER_BUILDER)
    {
        ...
        BASALT_MAX_HEIGHT = SERVER_BUILDER.comment("Maximal height for basalt pocket generation [0-255, default: 40]").defineInRange("basaltMaxHeight", 40, 0, 255);
        ...
        SLATE_MIN_HEIGHT = SERVER_BUILDER.comment("Minimal height for slate pocket generation, [0-255, default: 40]").defineInRange("slateMinHeight", 40, 0, 255);
        SLATE_MAX_HEIGHT = SERVER_BUILDER.comment("Maximal height for slate pocket generation [0-255, default: 70]").defineInRange("slateMaxHeight", 70, 0, 255);
        ...
        MARBLE_SIZE = SERVER_BUILDER.comment("Size of marble pockets [0-100, default: 25]").defineInRange("marbleSize", 25, 0, 100);
        ...
        MARBLE_MIN_HEIGHT = SERVER_BUILDER.comment("Minimal height for marble pocket generation, [0-255, default: 50]").defineInRange("marbleMinHeight", 50, 0, 255);
