...
public class ECBlocks
{
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event)
    {
        ...
        // event.getRegistry().register(
        // new CustomDoorBlock(Block.Properties.create(Material.IRON, MaterialColor.IRON).hardnessAndResistance(3.0F).sound(SoundType.LANTERN),
        // ToolType.PICKAXE).setRegistryName("warning_steel_door"));
        // event.getRegistry().register(
        ...
        // event.getRegistry().register(
        // new CustomDoorBlock(Block.Properties.create(Material.IRON, MaterialColor.IRON).hardnessAndResistance(5.0F).sound(SoundType.LANTERN),
        // ToolType.PICKAXE).setRegistryName("sturdy_white_steel_door"));
        // event.getRegistry().register(
        // new CustomDoorBlock(Block.Properties.create(Material.IRON, MaterialColor.IRON).hardnessAndResistance(3.0F).sound(SoundType.LANTERN),
        // ToolType.PICKAXE).setRegistryName("warning_white_steel_door"));
        // event.getRegistry().register(
        ...
        // event.getRegistry().register(
        // new CustomDoorBlock(Block.Properties.create(Material.IRON, MaterialColor.IRON).hardnessAndResistance(3.0F).sound(SoundType.LANTERN),
        // ToolType.PICKAXE).setRegistryName("warning_rusty_door"));

        // Stairs

        // event.getRegistry().register(new SuspendedStairsBlock(Block.Properties.create(Material.IRON, MaterialColor.IRON).hardnessAndResistance(3.0F).sound(SoundType.LANTERN),
        // ToolType.PICKAXE).setRegistryName(
