...
public class IndustrialItemModels extends ECItemModels
{
    ...
    public IndustrialItemModels(PackOutput output, String modid, ExistingFileHelper existingFileHelper, String name)
    {
    ...
    protected void registerModels()
    {
        ...
        {
            registerBlockBasics(DyeColor.byId(j).getName() + "_corrugated_metal_plate", true, true, true, true, true, true, true, false);
        }

        // Metal blocks
        registerBlockBasics("dark_metal_floor", true, true, true, true, true, false, false, false);
        registerBlockBasics("light_metal_floor", true, true, true, true, true, false, false, false);
        registerBlockBasics("rusty_plate", true, true, true, true, true, false, false, false);
