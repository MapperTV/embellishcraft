...
public class IndustrialRecipes extends ECRecipes
{
    ...
    protected void buildRecipes(RecipeOutput consumer)
    {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, InitIndustrialBlocks.IRON_BEAM.get(), 3).pattern("i").pattern("i").pattern("i").define('i', Tags.Items.INGOTS_IRON).unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).save(consumer, "iron_beam_vertical");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, InitIndustrialBlocks.IRON_BEAM.get()).requires(InitIndustrialBlocks.BOLTED_IRON_BEAM.get()).unlockedBy("has_bolted_iron_beam", has(InitIndustrialBlocks.IRON_BEAM.get())).save(consumer, "iron_beam_from_bolted");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, InitIndustrialBlocks.IRON_BEAM.get()).requires(InitIndustrialBlocks.IRON_BEAM_JUNCTION.get()).unlockedBy("has_iron_beam_junction", has(InitIndustrialBlocks.IRON_BEAM_JUNCTION.get())).save(consumer, "iron_beam_from_junction");
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, InitIndustrialBlocks.STEEL_BEAM.get(), 9).pattern("i").pattern("i").pattern("i").define('i', BaseTags.Items.INGOTS_STEEL).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).save(consumer, "steel_beam_vertical");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, InitIndustrialBlocks.STEEL_BEAM.get()).requires(InitIndustrialBlocks.BOLTED_STEEL_BEAM.get()).unlockedBy("has_bolted_steel_beam", has(InitIndustrialBlocks.STEEL_BEAM.get())).save(consumer, "steel_beam_from_bolted");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, InitIndustrialBlocks.STEEL_BEAM.get()).requires(InitIndustrialBlocks.STEEL_BEAM_JUNCTION.get()).unlockedBy("has_steel_beam_junction", has(InitIndustrialBlocks.STEEL_BEAM_JUNCTION.get())).save(consumer, "steel_beam_from_junction");
