...
public class IndustrialRecipes extends ECRecipes
{
    ...
    protected void buildRecipes(RecipeOutput consumer)
    {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, InitIndustrialBlocks.STURDY_STEEL_DOOR.get()).define('P', BaseTags.Items.PLATES_STEEL).define('D', InitIndustrialBlocks.STEEL_DOOR.get()).pattern("D").pattern("P").unlockedBy("has_steel_door", has(InitIndustrialBlocks.STEEL_DOOR.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, InitIndustrialBlocks.WARNING_STEEL_DOOR.get()).define('P', InitIndustrialBlocks.STEEL_DOOR.get()).define('D', Tags.Items.DYES_YELLOW).pattern("D").pattern("P").unlockedBy("has_steel_door", has(InitIndustrialBlocks.STEEL_DOOR.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, InitIndustrialBlocks.WHITE_STEEL_DOOR.get()).define('P', InitIndustrialBlocks.STEEL_DOOR.get()).define('D', Tags.Items.DYES_WHITE).pattern("D").pattern("P").unlockedBy("has_steel_door", has(InitIndustrialBlocks.STEEL_DOOR.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, InitIndustrialBlocks.STURDY_WHITE_STEEL_DOOR.get()).define('P', BaseTags.Items.PLATES_STEEL).define('D', InitIndustrialBlocks.WHITE_STEEL_DOOR.get()).pattern("D").pattern("P").unlockedBy("has_white_steel_door", has(InitIndustrialBlocks.WHITE_STEEL_DOOR.get())).save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, InitIndustrialBlocks.WARNING_WHITE_STEEL_DOOR.get()).define('P', InitIndustrialBlocks.WHITE_STEEL_DOOR.get()).define('D', Tags.Items.DYES_YELLOW).pattern("D").pattern("P").unlockedBy("has_white_steel_door", has(InitIndustrialBlocks.WHITE_STEEL_DOOR.get())).save(consumer);
