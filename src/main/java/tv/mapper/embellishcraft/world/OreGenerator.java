    ...
    public static void setupOregen()
    {
        ...
        for(Biome biome : ForgeRegistries.BIOMES)
        {
            ...
            if(CommonConfig.LARVIKITE_GENERATION.get())
                biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, ECBlockRegistry.ROCK_BLOCKS.get(
