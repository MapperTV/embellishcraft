            ...
            if(CommonConfig.BASALT_GENERATION.get())
            {
                if(CommonConfig.BASALT_WHITELIST_MODE.get())
                {
                    if(CommonConfig.BASALT_BIOME_LIST.get().contains(biome))
                    {
                        ...
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("Basalt whitelisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = false;
                }
                else
                {
                    if(CommonConfig.BASALT_BIOME_LIST.get().contains(biome))
                    {
                        generate = false;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("Basalt blacklisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = true;
                }
                ...
                if(generate)
                {
                    oreGen = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, ECBlockRegistry.ROCK_BLOCKS.get(
                        RockType.BASALT).get().getDefaultState(), CommonConfig.BASALT_SIZE.get())).withPlacement(
            ...
            if(CommonConfig.SLATE_GENERATION.get())
            {
                if(CommonConfig.SLATE_WHITELIST_MODE.get())
                {
                    if(CommonConfig.SLATE_BIOME_LIST.get().contains(biome))
                    {
                        generate = true;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("SLATE whitelisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = false;
                }
                else
                {
                    if(CommonConfig.SLATE_BIOME_LIST.get().contains(biome))
                    {
                        generate = false;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("SLATE blacklisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = true;
                }
                ...
                {
                    oreGen = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, ECBlockRegistry.ROCK_BLOCKS.get(
                        RockType.SLATE).get().getDefaultState(), CommonConfig.SLATE_SIZE.get())).withPlacement(
                            Placement.field_242907_l.configure(
            ...
            if(CommonConfig.MARBLE_GENERATION.get())
            {
                if(CommonConfig.MARBLE_WHITELIST_MODE.get())
                {
                    if(CommonConfig.MARBLE_BIOME_LIST.get().contains(biome))
                    {
                        generate = true;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("MARBLE whitelisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = false;
                }
                else
                {
                    if(CommonConfig.MARBLE_BIOME_LIST.get().contains(biome))
                    {
                        generate = false;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("MARBLE blacklisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = true;
                }
                ...
                {
                    oreGen = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, ECBlockRegistry.ROCK_BLOCKS.get(
                        RockType.MARBLE).get().getDefaultState(), CommonConfig.MARBLE_SIZE.get())).withPlacement(
                            Placement.field_242907_l.configure(
            ...
            if(CommonConfig.GNEISS_GENERATION.get())
            {
                if(CommonConfig.GNEISS_WHITELIST_MODE.get())
                {
                    if(CommonConfig.GNEISS_BIOME_LIST.get().contains(biome))
                    {
                        generate = true;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("GNEISS whitelisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = false;
                }
                else
                {
                    if(CommonConfig.GNEISS_BIOME_LIST.get().contains(biome))
                    {
                        generate = false;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("GNEISS blacklisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = true;
                }
                ...
                {
                    oreGen = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, ECBlockRegistry.ROCK_BLOCKS.get(
                        RockType.GNEISS).get().getDefaultState(), CommonConfig.GNEISS_SIZE.get())).withPlacement(
                            Placement.field_242907_l.configure(
            ...
            if(CommonConfig.JADE_GENERATION.get())
            {
                if(CommonConfig.JADE_WHITELIST_MODE.get())
                {
                    if(CommonConfig.JADE_BIOME_LIST.get().contains(biome))
                    {
                        generate = true;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("JADE whitelisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = false;
                }
                else
                {
                    if(CommonConfig.JADE_BIOME_LIST.get().contains(biome))
                    {
                        generate = false;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("JADE blacklisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = true;
                }
                ...
                {
                    oreGen = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, ECBlockRegistry.ROCK_BLOCKS.get(
                        RockType.JADE).get().getDefaultState(), CommonConfig.JADE_SIZE.get())).withPlacement(
                            Placement.field_242907_l.configure(
            ...
            if(CommonConfig.LARVIKITE_GENERATION.get())
            {
                if(CommonConfig.LARVIKITE_WHITELIST_MODE.get())
                {
                    if(CommonConfig.LARVIKITE_BIOME_LIST.get().contains(biome))
                    {
                        generate = true;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("LARVIKITE whitelisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = false;
                }
                else
                {
                    if(CommonConfig.LARVIKITE_BIOME_LIST.get().contains(biome))
                    {
                        generate = false;
                        if(ClientConfig.ENABLE_GEN_LOGS.get())
                            EmbellishCraft.LOGGER.info("LARVIKITE blacklisted for biome " + biome + " in the config.");
                    }
                    else
                        generate = true;
                }
                ...
                {
                    oreGen = Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, ECBlockRegistry.ROCK_BLOCKS.get(
                        RockType.LARVIKITE).get().getDefaultState(), CommonConfig.LARVIKITE_SIZE.get())).withPlacement(Placement.field_242907_l.configure(
