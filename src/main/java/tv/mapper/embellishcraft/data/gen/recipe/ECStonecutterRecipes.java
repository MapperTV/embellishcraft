    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer)
    {
        for(int j = 0; j < Arrays.stream(RockType.values()).count(); j++)
        {
            ...
            SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(ECBlockRegistry.ROCK_BLOCKS.get(RockType.byId(j)).get()), ECBlockRegistry.ROCK_BUTTONS.get(RockType.byId(j)).get(), 2).addCriterion(
                "has_" + RockType.byId(j).getName(), hasItem(ECBlockRegistry.ROCK_BLOCKS.get(RockType.byId(j)).get())).build(consumer,
            ...
            basicRecipes(consumer, ECBlockRegistry.ROCK_COBBLESTONE_BRICKS.get(RockType.byId(j)).get(), ECBlockRegistry.ROCK_COBBLESTONE_BRICKS_SLABS.get(RockType.byId(j)).get(),
                    ECBlockRegistry.ROCK_COBBLESTONE_BRICKS_STAIRS.get(RockType.byId(j)).get(), ECBlockRegistry.ROCK_COBBLESTONE_BRICKS_WALLS.get(RockType.byId(j)).get(),
                    ECBlockRegistry.ROCK_COBBLESTONE_BRICKS_PRESSURE_PLATES.get(RockType.byId(j)).get());
            ...
            SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(ECBlockRegistry.POLISHED_ROCK_BLOCKS.get(RockType.byId(j)).get()), ECBlockRegistry.ROCK_ORNAMENTS.get(RockType.byId(j)).get(),
                2).addCriterion("has_polished_" + RockType.byId(j).getName(), hasItem(ECBlockRegistry.POLISHED_ROCK_BLOCKS.get(RockType.byId(j)).get())).build(consumer,
            ...
            SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(ECBlockRegistry.ROCK_ORNAMENTS.get(RockType.byId(j)).get()),
                ECBlockRegistry.ROCK_ORNAMENT_PRESSURE_PLATES.get(RockType.byId(j)).get(), 2).addCriterion("has_" + RockType.byId(j).getName() + "_ornament",
                    hasItem(ECBlockRegistry.ROCK_ORNAMENTS.get(RockType.byId(j)).get())).build(consumer,
        ...
        // Andesite
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.ANDESITE), ECBlockRegistry.ANDESITE_BUTTON.get(), 2).addCriterion("has_andesite", hasItem(Blocks.ANDESITE)).build(consumer,
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.ANDESITE), ECBlockRegistry.ANDESITE_ORNAMENT.get()).addCriterion("has_andesite", hasItem(Blocks.ANDESITE)).build(consumer,
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(ECBlockRegistry.ANDESITE_ORNAMENT.get()), ECBlockRegistry.ANDESITE_ORNAMENT_PRESSURE_PLATE.get(), 2).addCriterion("has_andesite_ornament",
            hasItem(ECBlockRegistry.ANDESITE_ORNAMENT.get())).build(consumer, "andesite_ornament_pressure_place_from_andesite_ornament_stonecutting");

        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.ANDESITE), ECBlockRegistry.ANDESITE_ROOFTILES.get(), 2).addCriterion("has_andesite", hasItem(Blocks.ANDESITE)).build(consumer,
        ...
        // Diorite
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.DIORITE), ECBlockRegistry.DIORITE_BUTTON.get(), 2).addCriterion("has_diorite", hasItem(Blocks.DIORITE)).build(consumer,
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.DIORITE), ECBlockRegistry.DIORITE_ORNAMENT.get()).addCriterion("has_diorite", hasItem(Blocks.DIORITE)).build(consumer,
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(ECBlockRegistry.DIORITE_ORNAMENT.get()), ECBlockRegistry.DIORITE_ORNAMENT_PRESSURE_PLATE.get(), 2).addCriterion("has_diorite_ornament",
            hasItem(ECBlockRegistry.DIORITE_ORNAMENT.get())).build(consumer, "diorite_ornament_pressure_place_from_diorite_ornament_stonecutting");

        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.DIORITE), ECBlockRegistry.DIORITE_ROOFTILES.get(), 2).addCriterion("has_diorite", hasItem(Blocks.DIORITE)).build(consumer,
        ...
        // Granite
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.GRANITE), ECBlockRegistry.GRANITE_BUTTON.get(), 2).addCriterion("has_granite", hasItem(Blocks.GRANITE)).build(consumer,
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.GRANITE), ECBlockRegistry.GRANITE_ORNAMENT.get()).addCriterion("has_granite", hasItem(Blocks.GRANITE)).build(consumer,
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(ECBlockRegistry.GRANITE_ORNAMENT.get()), ECBlockRegistry.GRANITE_ORNAMENT_PRESSURE_PLATE.get(), 2).addCriterion("has_granite_ornament",
            hasItem(ECBlockRegistry.GRANITE_ORNAMENT.get())).build(consumer, "granite_ornament_pressure_place_from_granite_ornament_stonecutting");

        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.GRANITE), ECBlockRegistry.GRANITE_ROOFTILES.get(), 2).addCriterion("has_granite", hasItem(Blocks.GRANITE)).build(consumer,
        ...
        // Sandstone
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.SANDSTONE), ECBlockRegistry.SANDSTONE_BUTTON.get(), 2).addCriterion("has_sandstone", hasItem(Blocks.SANDSTONE)).build(consumer,
            "sandstone_button_from_sandstone_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.SMOOTH_SANDSTONE), ECBlockRegistry.SMOOTH_SANDSTONE_WALL.get()).addCriterion("has_smooth_sandstone",
            hasItem(Blocks.SMOOTH_SANDSTONE)).build(consumer, "smooth_sandstone_wall_from_smooth_sandstone_stonecutting");
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.SMOOTH_SANDSTONE), ECBlockRegistry.SMOOTH_SANDSTONE_PRESSURE_PLATE.get(), 2).addCriterion("has_smooth_sandstone",
            hasItem(Blocks.SMOOTH_SANDSTONE)).build(consumer, "smooth_sandstone_pressure_plate_from_smooth_sandstone_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.SANDSTONE), ECBlockRegistry.SANDSTONE_ROOFTILES.get(), 2).addCriterion("has_sandstone", hasItem(Blocks.SANDSTONE)).build(consumer,
            "sandstone_rooftiles_from_sandstone_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.RED_SANDSTONE), ECBlockRegistry.RED_SANDSTONE_BUTTON.get(), 2).addCriterion("has_red_sandstone",
            hasItem(Blocks.RED_SANDSTONE)).build(consumer, "red_sandstone_button_from_red_sandstone_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.SMOOTH_RED_SANDSTONE), ECBlockRegistry.SMOOTH_RED_SANDSTONE_WALL.get()).addCriterion("has_smooth_red_sandstone",
            hasItem(Blocks.SMOOTH_RED_SANDSTONE)).build(consumer, "smooth_red_sandstone_wall_from_smooth_red_sandstone_stonecutting");
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.SMOOTH_RED_SANDSTONE), ECBlockRegistry.SMOOTH_RED_SANDSTONE_PRESSURE_PLATE.get(), 2).addCriterion("has_smooth_red_sandstone",
            hasItem(Blocks.SMOOTH_RED_SANDSTONE)).build(consumer, "smooth_red_sandstone_pressure_plate_from_smooth_red_sandstone_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.RED_SANDSTONE), ECBlockRegistry.RED_SANDSTONE_ROOFTILES.get(), 2).addCriterion("has_red_sandstone",
            hasItem(Blocks.RED_SANDSTONE)).build(consumer, "red_sandstone_rooftiles_from_red_sandstone_stonecutting");
        ...
        // Terracotta
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.TERRACOTTA), ECBlockRegistry.TERRACOTTA_BUTTON.get(), 2).addCriterion("has_terracotta", hasItem(Blocks.TERRACOTTA)).build(consumer,
            "terracotta_button_from_terracotta_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(Blocks.TERRACOTTA), ECBlockRegistry.TERRACOTTA_ROOFTILES.get(), 2).addCriterion("has_terracotta", hasItem(Blocks.TERRACOTTA)).build(
