...
public class ECLootTables extends BaseLootTableProvider
{
    ...
    protected void addTables()
    {
        ...
        lootTables.put(ECBlockRegistry.ANDESITE_ROOFTILES.get(), createStandardTable(ECConstants.MODID, ECBlockRegistry.ANDESITE_ROOFTILES.get()));
        lootTables.put(ECBlockRegistry.ANDESITE_ROOFTILES_STAIRS.get(), createStandardTable(ECConstants.MODID, ECBlockRegistry.ANDESITE_ROOFTILES_STAIRS.get()));
        lootTables.put(ECBlockRegistry.ANDESITE_ROOFTILES_SLAB.get(), createSlabTable(ECConstants.MODID, ECBlockRegistry.ANDESITE_ROOFTILES_SLAB.get()));
        ...
        for(int j = 0; j < Arrays.stream(McWoods.values()).count(); j++)
        {
            ...
            lootTables.put(ECBlockRegistry.PLAIN_DOOR_BLOCKS.get(McWoods.byId(j)).get(), createDoorTable(ECConstants.MODID, ECBlockRegistry.PLAIN_DOOR_BLOCKS.get(McWoods.byId(j)).get()));
        ...
        for(int j = 0; j < Arrays.stream(DyeColor.values()).count(); j++)
        {
            ...
            lootTables.put(ECBlockRegistry.WARPED_FANCY_BED_BLOCKS.get(DyeColor.byId(j)).get(), createBedTable(ECConstants.MODID, ECBlockRegistry.WARPED_FANCY_BED_BLOCKS.get(DyeColor.byId(j)).get()));
            lootTables.put(ECBlockRegistry.CRIMSON_FANCY_BED_BLOCKS.get(DyeColor.byId(j)).get(), createBedTable(ECConstants.MODID, ECBlockRegistry.CRIMSON_FANCY_BED_BLOCKS.get(DyeColor.byId(j)).get()));
        }
