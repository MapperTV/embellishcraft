...
public class ECBlockTags extends BlockTagsProvider
{
    ...
    {
        this.getBuilder(BlockTags.STAIRS).add(ECBlocks.BASALT_STAIRS, ECBlocks.SLATE_STAIRS, ECBlocks.MARBLE_STAIRS, ECBlocks.GNEISS_STAIRS, ECBlocks.JADE_STAIRS, ECBlocks.LARVIKITE_STAIRS);
        ...
        this.getBuilder(BlockTags.SLABS).add(ECBlocks.BASALT_SLAB, ECBlocks.SLATE_SLAB, ECBlocks.MARBLE_SLAB, ECBlocks.GNEISS_SLAB, ECBlocks.JADE_SLAB, ECBlocks.LARVIKITE_SLAB);
        ...
        this.getBuilder(BlockTags.WALLS).add(ECBlocks.BASALT_WALL, ECBlocks.SLATE_WALL, ECBlocks.MARBLE_WALL, ECBlocks.GNEISS_WALL, ECBlocks.JADE_WALL, ECBlocks.LARVIKITE_WALL);
        ...
        this.getBuilder(BaseTags.ForgeBlocks.PRESSURE_PLATES).add(ECBlocks.BASALT_PRESSURE_PLATE, ECBlocks.SLATE_PRESSURE_PLATE, ECBlocks.MARBLE_PRESSURE_PLATE, ECBlocks.GNEISS_PRESSURE_PLATE,
            ECBlocks.JADE_PRESSURE_PLATE, ECBlocks.LARVIKITE_PRESSURE_PLATE);
