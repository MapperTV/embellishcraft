...
{
    protected RendererModel field_78234_a = (new RendererModel(this, 0, 0)).setTextureSize(16, 16);
    ...
    public LockerModel()
    {
        ...
        this.field_78233_c = (new RendererModel(this, 0, 0)).setTextureSize(16, 16);
        ...
        this.field_78232_b = (new RendererModel(this, 0, 19)).setTextureSize(16, 16);
