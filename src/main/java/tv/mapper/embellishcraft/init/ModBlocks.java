...
public class ModBlocks
{
    ...
    public static void registerItems(RegistryEvent.Register<Item> event)
    {
        ...
        event.getRegistry().register(new FuelBlockItem(BROWN_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BROWN_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLACK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLACK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLUE_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLUE_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(CYAN_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(CYAN_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GRAY_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GRAY_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GREEN_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GREEN_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_BLUE_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_BLUE_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_GRAY_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_GRAY_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIME_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIME_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(MAGENTA_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(MAGENTA_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(ORANGE_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(ORANGE_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PINK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PINK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PURPLE_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PURPLE_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(RED_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(RED_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(WHITE_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(WHITE_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(YELLOW_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(YELLOW_OAK_FANCY_BED.getRegistryName()));

        event.getRegistry().register(new FuelBlockItem(BROWN_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BROWN_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLACK_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLACK_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLUE_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLUE_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(CYAN_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(CYAN_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GRAY_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GRAY_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GREEN_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GREEN_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_BLUE_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_BLUE_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_GRAY_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_GRAY_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIME_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIME_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(MAGENTA_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(MAGENTA_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(ORANGE_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(ORANGE_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PINK_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PINK_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PURPLE_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PURPLE_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(RED_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(RED_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(WHITE_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(WHITE_BIRCH_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(YELLOW_BIRCH_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(YELLOW_BIRCH_FANCY_BED.getRegistryName()));

        event.getRegistry().register(new FuelBlockItem(BROWN_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BROWN_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLACK_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLACK_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLUE_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLUE_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(CYAN_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(CYAN_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GRAY_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GRAY_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GREEN_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GREEN_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_BLUE_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_BLUE_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_GRAY_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_GRAY_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIME_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIME_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(MAGENTA_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(MAGENTA_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(ORANGE_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(ORANGE_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PINK_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PINK_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PURPLE_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PURPLE_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(RED_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(RED_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(WHITE_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(WHITE_SPRUCE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(YELLOW_SPRUCE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(YELLOW_SPRUCE_FANCY_BED.getRegistryName()));

        event.getRegistry().register(new FuelBlockItem(BROWN_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BROWN_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLACK_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLACK_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLUE_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLUE_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(CYAN_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(CYAN_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GRAY_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GRAY_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GREEN_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GREEN_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_BLUE_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_BLUE_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_GRAY_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_GRAY_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIME_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIME_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(MAGENTA_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(MAGENTA_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(ORANGE_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(ORANGE_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PINK_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PINK_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PURPLE_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PURPLE_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(RED_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(RED_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(WHITE_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(WHITE_JUNGLE_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(YELLOW_JUNGLE_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(YELLOW_JUNGLE_FANCY_BED.getRegistryName()));

        event.getRegistry().register(new FuelBlockItem(BROWN_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BROWN_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLACK_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLACK_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLUE_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLUE_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(CYAN_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(CYAN_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GRAY_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GRAY_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GREEN_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GREEN_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_BLUE_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_BLUE_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_GRAY_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_GRAY_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIME_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIME_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(MAGENTA_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(MAGENTA_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(ORANGE_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(ORANGE_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PINK_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PINK_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PURPLE_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PURPLE_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(RED_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(RED_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(WHITE_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(WHITE_DARK_OAK_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(YELLOW_DARK_OAK_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(YELLOW_DARK_OAK_FANCY_BED.getRegistryName()));

        event.getRegistry().register(new FuelBlockItem(BROWN_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BROWN_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLACK_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLACK_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(BLUE_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(BLUE_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(CYAN_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(CYAN_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GRAY_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GRAY_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(GREEN_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(GREEN_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_BLUE_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_BLUE_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIGHT_GRAY_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIGHT_GRAY_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(LIME_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(LIME_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(MAGENTA_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(MAGENTA_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(ORANGE_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(ORANGE_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PINK_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PINK_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(PURPLE_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(PURPLE_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(RED_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(RED_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(WHITE_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(WHITE_ACACIA_FANCY_BED.getRegistryName()));
        event.getRegistry().register(new FuelBlockItem(YELLOW_ACACIA_FANCY_BED, new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT), Constants.bedBurnTime).setRegistryName(YELLOW_ACACIA_FANCY_BED.getRegistryName()));
