...
public class ECItemRegistry
{
    ...
    // Cobblestones
    public static final Map<RockType, RegistryObject<BlockItem>> ROCKS_COBBLESTONES_ITEMS = Arrays.stream(RockType.values()).map(
        type -> Pair.of(type, ITEMS.register(type.getName(), () -> new BlockItem(ECBlockRegistry.ROCK_COBBLESTONES.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    // Smooth rocks
    public static final Map<RockType, RegistryObject<BlockItem>> SMOOTH_ROCK_ITEMS = Arrays.stream(RockType.values()).map(
        type -> Pair.of(type, ITEMS.register(type.getName(), () -> new BlockItem(ECBlockRegistry.SMOOTH_ROCK_BLOCKS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> SMOOTH_ROCK_STAIRS_ITEMS = Arrays.stream(RockType.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getName() + "_stairs", () -> new BlockItem(ECBlockRegistry.SMOOTH_ROCK_STAIRS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> SMOOTH_ROCK_SLABS_ITEMS = Arrays.stream(RockType.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getName() + "_slab", () -> new BlockItem(ECBlockRegistry.SMOOTH_ROCK_SLABS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> SMOOTH_ROCK_WALLS_ITEMS = Arrays.stream(RockType.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getName() + "_wall", () -> new BlockItem(ECBlockRegistry.SMOOTH_ROCK_WALLS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> SMOOTH_ROCK_PRESSURE_PLATES_ITEMS = Arrays.stream(RockType.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getName() + "_pressure_plate", () -> new BlockItem(ECBlockRegistry.SMOOTH_ROCK_PRESSURE_PLATES.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));

    // Polished rocks
    public static final Map<RockType, RegistryObject<BlockItem>> POLISHED_ROCK_ITEMS = Arrays.stream(RockType.values()).map(
        type -> Pair.of(type, ITEMS.register(type.getName(), () -> new BlockItem(ECBlockRegistry.POLISHED_ROCK_BLOCKS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> POLISHED_ROCK_STAIRS_ITEMS = Arrays.stream(RockType.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getName() + "_stairs", () -> new BlockItem(ECBlockRegistry.POLISHED_ROCK_STAIRS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> POLISHED_ROCK_SLABS_ITEMS = Arrays.stream(RockType.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getName() + "_slab", () -> new BlockItem(ECBlockRegistry.POLISHED_ROCK_SLABS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> POLISHED_ROCK_WALLS_ITEMS = Arrays.stream(RockType.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getName() + "_wall", () -> new BlockItem(ECBlockRegistry.POLISHED_ROCK_WALLS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> POLISHED_ROCK_PRESSURE_PLATES_ITEMS = Arrays.stream(RockType.values()).map(type -> Pair.of(type,
        ITEMS.register(type.getName() + "_pressure_plate",
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> ROCKS_PAVINGS_ITEMS = Arrays.stream(RockType.values()).map(
        type -> Pair.of(type, ITEMS.register(type.getName(), () -> new BlockItem(ECBlockRegistry.ROCK_PAVINGS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> ROCKS_TILES_ITEMS = Arrays.stream(RockType.values()).map(
        type -> Pair.of(type, ITEMS.register(type.getName(), () -> new BlockItem(ECBlockRegistry.ROCK_TILES.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    public static final Map<RockType, RegistryObject<BlockItem>> ROCKS_BRICKS_ITEMS = Arrays.stream(RockType.values()).map(
        type -> Pair.of(type, ITEMS.register(type.getName(), () -> new BlockItem(ECBlockRegistry.ROCK_BRICKS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    // Rock large bricks
    public static final Map<RockType, RegistryObject<BlockItem>> ROCKS_LARGE_BRICKS_ITEMS = Arrays.stream(RockType.values()).map(
        type -> Pair.of(type, ITEMS.register(type.getName(), () -> new BlockItem(ECBlockRegistry.ROCK_LARGE_BRICKS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    // Rock ornaments
    public static final Map<RockType, RegistryObject<BlockItem>> ROCKS_ORNAMENTS_ITEMS = Arrays.stream(RockType.values()).map(
        type -> Pair.of(type, ITEMS.register(type.getName(), () -> new BlockItem(ECBlockRegistry.ROCK_ORNAMENTS.get(type).get(), new Item.Properties().group(ModItemGroups.EMBELLISHCRAFT))))).collect(
            Collectors.toMap(Pair::getKey, Pair::getValue));
    ...
    // public static final RegistryObject<Item> BASALT_SLAB_ITEM = ITEMS.register("basalt_slab", () -> new BlockItem(ECBlockRegistry.BASALT_SLAB.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    // public static final RegistryObject<Item> BASALT_WALL_ITEM = ITEMS.register("basalt_wall", () -> new BlockItem(ECBlockRegistry.BASALT_WALL.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    ...
    // public static final RegistryObject<Item> SLATE_SLAB_ITEM = ITEMS.register("slate_slab", () -> new BlockItem(ECBlockRegistry.SLATE_SLAB.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    // public static final RegistryObject<Item> SLATE_WALL_ITEM = ITEMS.register("slate_wall", () -> new BlockItem(ECBlockRegistry.SLATE_WALL.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    ...
    //
    // public static final RegistryObject<Item> SLATE_TILES_ITEM = ITEMS.register("slate_tiles", () -> new BlockItem(ECBlockRegistry.SLATE_TILES.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    ...
    // public static final RegistryObject<Item> MARBLE_SLAB_ITEM = ITEMS.register("marble_slab", () -> new BlockItem(ECBlockRegistry.MARBLE_SLAB.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    // public static final RegistryObject<Item> MARBLE_WALL_ITEM = ITEMS.register("marble_wall", () -> new BlockItem(ECBlockRegistry.MARBLE_WALL.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    ...
    // public static final RegistryObject<Item> GNEISS_SLAB_ITEM = ITEMS.register("gneiss_slab", () -> new BlockItem(ECBlockRegistry.GNEISS_SLAB.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    // public static final RegistryObject<Item> GNEISS_WALL_ITEM = ITEMS.register("gneiss_wall", () -> new BlockItem(ECBlockRegistry.GNEISS_WALL.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    ...
    // public static final RegistryObject<Item> JADE_STAIRS_ITEM = ITEMS.register("jade_stairs", () -> new BlockItem(ECBlockRegistry.JADE_STAIRS.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    // public static final RegistryObject<Item> JADE_SLAB_ITEM = ITEMS.register("jade_slab", () -> new BlockItem(ECBlockRegistry.JADE_SLAB.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    // public static final RegistryObject<Item> JADE_WALL_ITEM = ITEMS.register("jade_wall", () -> new BlockItem(ECBlockRegistry.JADE_WALL.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    ...
    // public static final RegistryObject<Item> JADE_BUTTON_ITEM = ITEMS.register("jade_button", () -> new BlockItem(ECBlockRegistry.JADE_BUTTON.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    //
    ...
    //
    // public static final RegistryObject<Item> SMOOTH_JADE_ITEM = ITEMS.register("smooth_jade", () -> new BlockItem(ECBlockRegistry.SMOOTH_JADE.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    ...
    //
    // public static final RegistryObject<Item> JADE_PAVING_ITEM = ITEMS.register("jade_paving", () -> new BlockItem(ECBlockRegistry.JADE_PAVING.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    ...
    //
    // public static final RegistryObject<Item> JADE_TILES_ITEM = ITEMS.register("jade_tiles", () -> new BlockItem(ECBlockRegistry.JADE_TILES.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    ...
    //
    // public static final RegistryObject<Item> JADE_BRICKS_ITEM = ITEMS.register("jade_bricks", () -> new BlockItem(ECBlockRegistry.JADE_BRICKS.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
    ...
    //
    // // Larvikite
    // public static final RegistryObject<Item> LARVIKITE_ITEM = ITEMS.register("larvikite", () -> new BlockItem(ECBlockRegistry.LARVIKITE.get(), new
    // Item.Properties().group(ModItemGroups.EMBELLISHCRAFT)));
